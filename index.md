...
| Large Breadboard | Use to hold the wires in place without the need of soldering, allowing the electrical circuits to flow | $5.95 | <a href=""> Link </a> |
...
| Male to Male jumper wires | Allow the electrical current to flow between all of the components on the breadboard | $12.99 | <a href=""> Link </a> |
